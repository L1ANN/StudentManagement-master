...
<script type="text/javascript">
    ...
    function priorPage() {
        ...
        window.location.href = "SelectStudent.do?jsp=classlist&p=" + p + "&sqlname=" + name + "&sqlvalue=" + value;
    ...
    function jumpPage() {
        ...
        var name = document.getElementById("sql_name").value;
        var value = document.getElementById("sqlvalue").value;
        window.location.href = "SelectStudent.do?jsp=classlist&p=" + p2 + "&sqlname=" + name + "&sqlvalue=" + value;
    ...
    function selectByCondition() {
        var name = document.getElementById("sqlname").value;
        var value = document.getElementById("sqlvalue").value;
        window.location.href = "SelectStudent.do?jsp=classlist&sqlname=" + name + "&sqlvalue=" + value;

    }

    function update(num) {
        window.location.href = "DetailStudent.do?jsp=classdetail&stu_num=" + num;
    }
